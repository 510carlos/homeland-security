...
<div id="container">
    ...
    <ul class="nav nav-tabs">
    	<li <?=($view=="user")?'class="active"':''?>><a href="#register" data-toggle="tab">Register</a></li>
        <li <?=($view=="casses")?'class="active"':''?>><a href="#home" data-toggle="tab">Casses</a></li>
        <li <?=($view=="admin")?'class="active"':''?>><a href="#profile" data-toggle="tab">Report</a></li>
    </ul>
    
    <!-- Tab panes -->
    <div class="tab-content">
    	<div class="tab-pane <?=($view=="user")?'active':''?>" id="register">
        ...
        <div class="tab-pane <?=($view=="casses")?'active':''?>" id="home">
            <div class="panel panel-default">
                <div class="panel-body">
                    <!-- Nav tabs -->
        ...
        <div class="tab-pane <?=($view=="admin")?'active':''?>" id="profile">
            <div class="panel panel-default">
                <div class="panel-body">
